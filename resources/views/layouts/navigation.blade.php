            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <form method="GET" action="{{ route('products.search') }}" class="relative">
                        <input name="query" placeholder="Search..." class="border rounded-md p-2 mt-3 text-black" />
                        <button type="submit bg-black" class="absolute right-0 top-0 mt-6 mr-2">
                            <svg class="h-6 w-6 text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
